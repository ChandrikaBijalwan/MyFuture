...
/**
 * Created by Chandrika on 20/09/16.
 */
...
//		mBorderWidth = a.getDimensionPixelSize(R.styleable.CircularImageView_civ_border, DEFAULT_BORDER_WIDTH);
//		mBorderColor = a.getColor(R.styleable.CircularImageView_civ_selector, DEFAULT_BORDER_COLOR);
//		mBorderOverlay = a.getBoolean(R.styleable.CircularImageView_civ_shadow, DEFAULT_BORDER_OVERLAY);
